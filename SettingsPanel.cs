...
public class SettingsPanel : BasePanel
{
    ...
    public static void RefreshSettings()
    {
        ...
        GlobalDataManager.GetInstance().UpdateTextSpeed(globalData.TextSpeed);
        GlobalDataManager.GetInstance().UpdateAutoSpeed(globalData.AutoSpeed);
        GlobalDataManager.GetInstance().UpdateDisplayMode(globalData.IsFullScreen);
    }
}